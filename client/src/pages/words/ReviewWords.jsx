...
export default function ReviewWords() {
  ...
  return (
    <div className="max-w-2xl mx-auto px-4 py-8">
      ...
      <div className="card text-center py-10" onClick={() => { if (!showAnswer) setShowAnswer(true); }}>
        <button
            ...
            <div className="flex flex-wrap justify-center gap-2">
              {qualityLabels.map((q) => (
                <button
                  ...
                  className={`px-3 py-2 rounded-lg text-xs font-medium text-white hover:opacity-90 transition-opacity ${isTouch ? 'px-5 py-3 text-sm min-h-[52px]' : ''}`}
